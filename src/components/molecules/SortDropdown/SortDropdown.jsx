...
const SORT_OPTIONS = ["Most Popular", "Price: Low-High", "Price: High-Low", "Newest Arrivals"];
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        ...
        <ChevronDown
          size={14}
          className="absolute right-0 top-1/2 -translate-y-1/2 text-[#4A3525] pointer-events-none"
        />
      </div>
    </div>
  );
