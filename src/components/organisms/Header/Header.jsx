    ...
    <header className="sticky top-0 z-50 w-full bg-[#FDFBF7] border-b border-[#F5F0E6] shadow-sm">
      <div className="container mx-auto px-4 md:px-8 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-10">
          <Link href="/about" className="text-sm font-semibold tracking-wider text-[#6B4F3B] hover:text-[#EC7F13] transition-colors">
            ABOUT
          </Link>
          <Link href="/products" className="text-sm font-semibold tracking-wider text-[#6B4F3B] hover:text-[#EC7F13] transition-colors">
            PRODUCTS
          </Link>
          <Link href="/contact" className="text-sm font-semibold tracking-wider text-[#6B4F3B] hover:text-[#EC7F13] transition-colors">
            CONTACT US
          </Link>
        </nav>
