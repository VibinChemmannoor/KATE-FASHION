      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 mb-16">
          ...
          <div className="md:col-span-4 lg:col-span-5">
            <h2 className="text-3xl font-serif font-bold tracking-wider mb-6 text-[#FDFBF7]">
              KATERI
            </h2>
            <p className="text-sm md:text-base text-[#F5F0E6]/80 leading-relaxed mb-8 max-w-sm font-sans">
              Sustainability meets style. We're dedicated to creating beautiful, safe, and organic
              garments for the next generation.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                aria-label="Globe"
                className="h-10 w-10 rounded-full border border-[#F5F0E6]/30 flex items-center justify-center hover:bg-[#F5F0E6]/10 hover:border-[#F5F0E6]/50 transition-all"
              >
                <Globe size={18} />
              </a>
              <a
          ...
          <div className="md:col-span-2 lg:col-span-2">
            <h3 className="text-lg font-serif mb-6 text-[#D5A070] font-medium tracking-wide">
              Collection
            </h3>
            <ul className="space-y-4 text-sm font-sans text-[#F5F0E6]/80">
              ...
              <li>
                <Link href="/gift-cards" className="hover:text-[#FDFBF7] transition-colors">
                  Gift Cards
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm font-sans text-[#F5F0E6]/80">
              ...
              <li>
                <Link href="/pages/care-guide" className="hover:text-[#FDFBF7] transition-colors">
                  Care Guide
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-[#F5F0E6]/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-sans text-[#F5F0E6]/50 tracking-wider">
          ...
          <div className="flex space-x-6">
            <Link href="/pages/privacy" className="hover:text-[#FDFBF7] transition-colors">
              PRIVACY
            </Link>
            <Link href="/pages/terms" className="hover:text-[#FDFBF7] transition-colors">
              TERMS
            </Link>
            <Link href="/pages/cookies" className="hover:text-[#FDFBF7] transition-colors">
              COOKIES
            </Link>
          </div>
        </div>
