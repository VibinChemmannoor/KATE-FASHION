  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-16 border-t border-[#F5F0E6] mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
        {/* Material & Care */}
        <div>
          <h2 className="text-3xl font-serif font-bold text-[#4A3525] mb-6 italic">
            Material & Care
          </h2>
            ...
            <table className="w-full text-left text-sm font-sans">
              <thead>
                <tr className="bg-[#FAF9F6] border-b border-[#F5F0E6]">
                  <th className="py-4 px-4 font-bold text-[#4A3525] uppercase tracking-wider text-xs">
                    Size
                  </th>
                  <th className="py-4 px-4 font-bold text-[#4A3525] uppercase tracking-wider text-xs text-center">
                    Age
                  </th>
                  <th className="py-4 px-4 font-bold text-[#4A3525] uppercase tracking-wider text-xs text-center">
                    Height
              ...
              <tbody>
                {sizeChart.map((row, idx) => (
                  <tr
                    key={idx}
                    className="border-b border-[#F5F0E6]/50 hover:bg-[#FAF9F6] transition-colors"
                  >
