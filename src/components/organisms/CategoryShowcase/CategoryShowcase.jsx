  ...
  return (
    <section className="container mx-auto px-4 md:px-8 py-16 mb-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-sm font-sans text-[#6B4F3B]/60 tracking-wide">Thoughtfully curated for every milestone</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative h-[450px] rounded-2xl overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-[#C8A488]">
             <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[#4A3525]/40 font-serif italic text-lg">Newborn Vector Image</span>
             </div>
          </div>
