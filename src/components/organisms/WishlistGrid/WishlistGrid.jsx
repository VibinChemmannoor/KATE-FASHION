  ...
  return (
    <section className="container mx-auto px-4 md:px-8 py-10 md:py-16">
      ...
      <div className="flex items-center text-xs font-bold uppercase tracking-widest text-[#6B4F3B]/60 mb-6 font-sans">
        <a href="/" className="hover:text-[#EC7F13] transition-colors">HOME</a>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-[#1a1b26] mb-3 tracking-tight">My Favorites</h1>
          <p className="text-sm font-sans text-[#6B4F3B]/70 tracking-wide">
            You have <span className="font-semibold text-[#4A3525]">{WISHLIST_ITEMS.length}</span> timeless pieces saved in your collection.
          </p>
        </div>
