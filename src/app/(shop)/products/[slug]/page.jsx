...
const mockProduct = {
  ...
  materialInfo: {
    description:
      "Our commitment to your baby's skin and the planet starts with our materials. This romper is made from GOTS (Global Organic Textile Standard) certified long-staple cotton.",
    bullets: [
    ...
    <div className="bg-[#FDFBF7] min-h-screen">
      <div className="container mx-auto px-4 md:px-8 pt-8 pb-4">
        ...
        <div className="flex items-center text-[10px] font-bold uppercase tracking-[0.2em] text-[#6B4F3B]/60 mb-8 font-sans">
          ...
          <Link href="/collections/newborn" className="hover:text-[#EC7F13] transition-colors">
            NEWBORN
          </Link>
          <span className="mx-2">/</span>
